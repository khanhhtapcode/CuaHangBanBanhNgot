        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="position-center">
                    <form role="form" method="post" action="{{ route('admin.luu_sanpham') }}" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="9" cols="125" name="product_desc" id="exampleInputPassword1" placeholder="mô tả"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Nội dung sản phẩm</label>
                            <textarea style="resize: none" rows="9" cols="125" name="product_content" id="exampleInputPassword1" placeholder="nhập nội dung"></textarea>
                        </div>
                        <div class="form-group">
